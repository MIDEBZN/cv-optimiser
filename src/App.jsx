...
- Generate a highly professional, well-structured but generic Canadian cover letter. Focus on the candidate's core strengths, adaptability, and readiness to contribute, without referencing any specific company or hiring manager, so it can be reused easily for multiple applications. Format the cover letter in Markdown: put the candidate's name as a # Heading 1 at the top, followed by contact info, date, a general greeting (e.g., "Madame, Monsieur,"), and beautifully spaced body paragraphs.
